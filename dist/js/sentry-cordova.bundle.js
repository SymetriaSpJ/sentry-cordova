...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.setTag = function (key, value) {
        var _a;
        this.tags = tslib_1.__assign({}, this.tags, (_a = {}, _a[key] = object.safeNormalize(value), _a));
        this.notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setExtra = function (key, extra) {
        var _a;
        this.extra = tslib_1.__assign({}, this.extra, (_a = {}, _a[key] = object.safeNormalize(extra), _a));
        this.notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
        this.breadcrumbs =
            maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0
                ? tslib_1.__spread(this.breadcrumbs, [object.safeNormalize(breadcrumb)]).slice(-maxBreadcrumbs)
                : tslib_1.__spread(this.breadcrumbs, [object.safeNormalize(breadcrumb)]);
        this.notifyScopeListeners();
    };
    /**
...
function normalizeValue(value, key) {
    ...
    if (typeof commonjsGlobal$$1 !== 'undefined' && value === commonjsGlobal$$1) {
        return '[Global]';
    }
    if (typeof window !== 'undefined' && value === window) {
        return '[Window]';
...
var dist_4$3 = dist_3$3.addGlobalEventProcessor;
var dist_5$3 = dist_3$3.addBreadcrumb;
var dist_6$3 = dist_3$3.captureException;
var dist_7$3 = dist_3$3.captureEvent;
var dist_8$1 = dist_3$3.captureMessage;
var dist_9$1 = dist_3$3.configureScope;
var dist_10$1 = dist_3$3.withScope;
var dist_11$1 = dist_3$3.getHubFromCarrier;
var dist_12$1 = dist_3$3.getCurrentHub;
var dist_13$1 = dist_3$3.Hub;
var dist_14$1 = dist_3$3.Scope;
var dist_15$1 = dist_3$3.Integrations;
var dist_16$1 = dist_3$3.Transports;
var dist_17$1 = dist_3$3.Severity;
var dist_18$1 = dist_3$3.Status;
var dist_19$1 = dist_3$3.BrowserBackend;
var dist_20$1 = dist_3$3.BrowserClient;
var dist_21$1 = dist_3$3.defaultIntegrations;
var dist_22 = dist_3$3.forceLoad;
var dist_23 = dist_3$3.init;
...
var CordovaBackend = /** @class */ (function (_super) {
    ...
    function CordovaBackend(options) {
        ...
        _this.browserBackend = new dist_19$1(options);
        return _this;
    }
    /**
     * @inheritDoc
...
var CordovaClient = /** @class */ (function (_super) {
     ...
     * @inheritDoc
     */
    CordovaClient.prototype.prepareEvent = function (event, scope, hint) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                event.platform = event.platform || 'javascript';
...
var Release = /** @class */ (function () {
    ...
    Release.prototype.setupOnce = function () {
        ...
        dist_7$2(function (event) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                self = dist_8().getIntegration(Release);
                if (!self) {
                    return [2 /*return*/, event];
                }
                window = misc_3();
...
var Cordova = /** @class */ (function () {
    ...
    Cordova.prototype.setupOnce = function () {
        ...
        dist_7$2(function (event) { return __awaiter(_this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = dist_8().getIntegration(Cordova);
                if (self) {
                    return [2 /*return*/, normalizeData(event)];
                }
                return [2 /*return*/, event];
            });
        }); });
...
function init(options) {
    if (options.defaultIntegrations === undefined) {
        options.defaultIntegrations = __spread(dist_21$1, [new Cordova(), new Release()]);
    }
    dist_19(CordovaClient, options);
}
function setRelease(release) {
    dist_5$1(function (scope) {
